{
  "beers": [{
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "Highly carbonated, very light-bodied, nearly flavorless lager designed to be consumed very cold. Very refreshing and thirst quenching.",
  ...
  },
  {
    ...
    "subcategories": [{
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A well-attenuated malty amber lager with an interesting caramel or toast quality and restrained bitterness. Usually fairly well-attenuated, often with an adjunct quality. Smooth, easily-drinkable lager character.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A darker and somewhat sweeter version of international pale lager with a little more body and flavor, but equally restrained in bitterness. The low bitterness leaves the malt as the primary flavor element, and the low hop levels provide very little in the way of balance.",
  ...
  },
  {
    ...
    "subcategories": [{
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "Malt-driven amber Czech lager with hop character that can vary from low to quite significant. The malt flavors can vary quite a bit, leading to different interpretations ranging from drier, bready, and slightly biscuity to sweeter and somewhat caramelly",
      ...
      },
      {
        ...
        "letter": "D",
        "guidelines": {
          "overallImpression": "A rich, dark, malty Czech lager with a roast character that can vary from almost absent to quite prominent. Malty with an interesting and complex flavor profile, with variable levels of hopping providing a range of possible interpretations.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A clean, malty, gold-colored German lager with a smooth grainy-sweet malty flavor and a soft, dry finish. Subtle spicy, floral, or herbal hops and restrained bitterness help keep the balance malty but not sweet, which helps make this beer a refreshing, everyday drink.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A smooth, clean, pale German lager with a moderately strong malty flavor and a light hop character. Deftly balances strength and drinkability, with a palate impression and finish that encourages drinking. Showcases elegant German malt flavors without becoming too heavy or filling.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A relatively pale, strong, malty German lager beer with a nicely attenuated finish that enhances drinkability. The hop character is generally more apparent than in other bocks.",
          ...
          "ingredients": "Base of Pils and/or Vienna malt with some Munich malt to add character (although much less than in a traditional bock). No non-malt adjuncts. Saazertype hops. Clean lager yeast. Decoction mash is typical, but boiling is less than in Dunkles Bock to restrain color development.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A pale, highly-attenuated, light-bodied German lager with lower alcohol and calories than normalstrength beers. Moderately bitter with noticeable malt and hop flavors, the beer is still interesting to drink.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A pale, well-balanced, smooth German lager that is slightly stronger than the average beer with a moderate body and a mild, aromatic hop and malt character.",
      ...
      },
      {
        ...
        "letter": "D",
        "guidelines": {
          "overallImpression": "A light-bodied, highly-attenuated, gold-colored, bottom-fermented bitter German beer showing excellent head retention and an elegant, floral hop aroma. Crisp, clean, and refreshing, a German Pils showcases the finest quality German malt and hops.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "An elegant, malty German amber lager with a clean, rich, toasty and bready malt flavor, restrained bitterness, and a dry finish that encourages another drink. The overall malt impression is soft, elegant, and complex, with a rich aftertaste that is never cloying or heavy.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "An elegant, malty German amber lager with a balanced, complementary beechwood smoke character. Toasty-rich malt in aroma and flavor, restrained bitterness, low to high smoke flavor, clean fermentation profile, and an attenuated finish are characteristic.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A dark, strong, malty German lager beer that emphasizes the malty-rich and somewhat toasty qualities of continental malts without being sweet in the finish.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A moderate-strength amber lager with a soft, smooth maltiness and moderate bitterness, yet finishing relatively dry. The malt flavor is clean, bready-rich, and somewhat toasty, with an elegant impression derived from quality base malts and process, not specialty malts and adjuncts.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A well-balanced, well-attenuated, bitter yet malty, clean, and smooth, amber- to copper-colored German beer. The bitterness is balanced by the malt richness, but the malt intensity and character can range from moderate to high (the bitterness increases with the malt richness). ",
      ...
      },
      {
        ...
        "guidelines": {
          ...
          "appearance": "Moderately cloudy to clear depending on age, but never extremely cloudy or murky. Gold to deep reddishamber color. Off-white, creamy head. When served on cask, can have low carbonation and very low head.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "commercialExamples": [{
          ...
          {
            "name": "Weihenstephaner Korbinian,; Pale Versions – Eggenberg Urbock 23º"
          },
          {
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A Baltic Porter often has the malt flavors reminiscent of an English porter and the restrained roast of a schwarzbier, but with a higher OG and alcohol content than either. Very complex, with multi-layered malt and dark fruit flavors.",
          ...
          "comparison": "Much less roasted and smoother than an Imperial Stout, typically with less alcohol. Lacks the roasty qualities of stouts in general, more taking on the roasted-butnot-burnt characteristics of a schwarzbier. Quite fruity compared to other porters. Higher alcohol than other porters.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A pale, refreshing German wheat beer with high carbonation, dry finish, a fluffy mouthfeel, and a distinctive banana-and-clove yeast character.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A moderately dark German wheat beer with a distinctive banana-and-clove yeast character, supported by a toasted bread or caramel malt flavor. Highly carbonated and refreshing, with a creamy, fluffy texture and light finish that encourages drinking.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A strong, malty, fruity, wheat-based ale combining the best malt and yeast flavors of a weissbier (pale or dark) with the malty-rich flavor, strength, and body of a Dunkles Bock or Doppelbock.",
          ...
          "comparison": "tronger and richer than a Weissbier or Dunkles Weissbier, but with similar yeast character. More directly comparable to the Doppelbock style, with the pale and dark variations. Can vary widely in strength, but most are in the bock to doppelbock range.",
          "instruction": "The entrant will specify whether the entry is a pale or a dark version.",
          "vitalStatistics": {
            "og": "1.064 - 1.090",
            "fg": "1.015 - 1.022",
            "abv": "6.5 - 9.0%",
        ...
        "commercialExamples": [{
          ...
          {
            "name": "Schneider Unser Aventinus; Pale –Plank Bavarian Heller Weizenbock"
          },
          {
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "Low gravity, low alcohol levels, and low carbonation make this an easy-drinking session beer. The malt profile can vary in flavor and intensity, but should never override the overall bitter impression. Drinkability is a critical component of the style",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "An average-strength to moderately-strong British bitter ale. The balance may be fairly even between malt and hops to somewhat bitter. Drinkability is a critical component of the style. A rather broad style that allows for considerable interpretation by the brewer.",
          ...
          "appearance": "ight amber to deep copper color. Good to brilliant clarity. Low to moderate white to off-white head. A low head is acceptable when carbonation is also low.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A hop-forward, average-strength to moderately-strong pale bitter. Drinkability and a refreshing quality are critical components of the style.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "Smooth and balanced, all components merge together with similar intensities. Moderate flavors showcasing Australian ingredients. Large flavor dimension. Very drinkable, suited to a hot climate. Relies on yeast character.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A hoppy, moderately-strong, very well-attenuated pale British ale with a dry finish and a hoppy aroma and flavor. Classic British ingredients provide the best flavor profile.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A dark, low-gravity, malt-focused British session ale readily suited to drinking in quantity. Refreshing, yet flavorful, with a wide range of dark malt or dark sugar expression.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A malty, brown caramel-centric British ale without the roasted flavors of a Porter.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A moderate-strength brown beer with a restrained roasty character and bitterness. May have a range of roasted flavors, generally without burnt qualities, and often has a chocolate-caramel-malty profile.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "An easy-drinking pint, often with subtle flavors. Slightly malty in the balance sometimes with an initial soft toffee/caramel sweetness, a slightly grainy-biscuity palate, and a touch of roasted dryness in the finish. Some versions can emphasize the caramel and sweetness more, while others will favor the grainy palate and roasted dryness.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": " black beer with a pronounced roasted flavor, often similar to coffee. The balance can range from fairly even to quite bitter, with the more balanced versions having a little malty sweetness and the bitter versions being quite dry. Draught versions typically are creamy from a nitro pour, but bottled versions will not have this dispense-derived character. The roasted flavor can be dry and coffee-like to somewhat chocolaty.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A very dark, sweet, full-bodied, slightly roasty ale that can suggest coffee-and-cream, or sweetened espresso.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A very dark, full-bodied, roasty, malty ale with a complementary oatmeal flavor. The sweetness, balance, and oatmeal impression can vary considerably.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A very dark, sweet, fruity, moderately strong ale with smooth roasty flavors without a burnt harshness.",
      ...
      },
      {
        ...
        "letter": "D",
        "guidelines": {
          "overallImpression": "A very dark, moderately strong, fairly dry, stout with prominent roast flavors.",
  ...
  },
  {
    ...
    "subcategories": [{
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "Rich, malty, dextrinous, and usually caramel-sweet, these beers can give an impression that is suggestive of a dessert. Complex secondary malt and alcohol flavors prevent a one-dimensional quality. Strength and maltiness can vary, but should not be cloying or syrupy.",
      ...
      },
      {
        ...
        "letter": "D",
        "guidelines": {
          "overallImpression": "A showcase of malty richness and complex, intense flavors. Chewy and rich in body, with warming alcohol and a pleasant fruity or hoppy interest. When aged, it can take on port-like flavors. A wintertime sipper.",
  ...
  },
  {
    ...
    "subcategories": [{
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A pale, refreshing and hoppy ale, yet with sufficient supporting malt to make the beer balanced and drinkable. The clean hop presence can reflect classic or modern American or New World hop varieties with a wide range of characteristics. An average-strength hop-forward pale American craft beer, generally balanced to be more accessible than modern American IPAs.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "An amber, hoppy, moderate-strength American craft beer with a caramel malty flavor. The balance can vary quite a bit, with some versions being fairly malty and others being aggressively hoppy. Hoppy and bitter versions should not have clashing flavors with the caramel malt profile.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A lightly fruity beer with firm, grainy maltiness, interesting toasty and caramel flavors, and showcasing rustic, traditional American hop characteristics.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A malty but hoppy beer frequently with chocolate and caramel flavors. The hop flavor and aroma complements and enhances the malt rather than clashing with it.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A substantial, malty dark beer with a complex and flavorful dark malt character.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A fairly strong, highly roasted, bitter, hoppy dark stout. Has the body and dark flavors typical of stouts with a more aggressive American hop character and bitterness.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "An intensely-flavored, big, dark ale with a wide range of flavor balances and regional interpretations. Roasty-burnt malt with deep dark or dried fruit flavors, and a warming, bittersweet finish. Despite the intense flavors, the components need to meld together to create a complex, harmonious beer, not a hot mess.",
        ...
        "commercialExamples": [{
          ...
          {
            "name": "Sierra Nevada Narwhal Imperial Stout; English – Courage Imperial Russian Stout"
          },
          {
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A decidedly hoppy and bitter, moderately strong American pale ale, showcasing modern American or New World hop varieties. The balance is hop-forward, with a clean fermentation profile, dryish finish, and clean, supporting malt allowing a creative range of hop character to shine through.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "Recognizable as an IPA by balance – a hop-forward, bitter, dryish beer – with something else present to distinguish it from the standard categories. Should have good drinkability, regardless of the form. Excessive harshness and heaviness are typically faults, as are strong flavor clashes between the hops and the other specialty ingredients.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "An IPA with the fruitiness and spiciness derived from the use of Belgian yeast. The examples from Belgium tend to be lighter in color and more attenuated, similar to a tripel that has been brewed with more hops. This beer has a more complex flavor profile and may be higher in alcohol than a typical IPA.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A beer with the dryness, hop-forward balance, and flavor characteristics of an American IPA, only darker in color – but without strongly roasted or burnt flavors. The flavor of darker malts is gentle and supportive, not a major flavor component. Drinkability is a key characteristic.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "Hoppy, bitter, and moderately strong like an American IPA, but with some caramel, chocolate, toffee, and/or dark fruit malt character as in an American Brown Ale. Retaining the dryish finish and lean body that makes IPAs so drinkable, a Brown IPA is a little more flavorful and malty than an American IPA without being sweet or heavy.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "Hoppy, bitter, and moderately strong like an American IPA, but with some caramel, toffee, and/or dark fruit malt character. Retaining the dryish finish and lean body that makes IPAs so drinkable, a Red IPA is a little more flavorful and malty than an American IPA without being sweet or heavy.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A fruity, spicy, refreshing version of an American IPA, but with a lighter color, less body, and featuring either the distinctive yeast and/or spice additions typical of a Belgian witbier.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "An intensely hoppy, fairly strong pale ale without the big, rich, complex maltiness and residual sweetness and body of an American barleywine. Strongly hopped, but clean, dry, and lacking harshness. Drinkability is an important characteristic; this should not be a heavy, sipping beer.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A strong, full-flavored American ale that challenges and rewards the palate with full malty and hoppy flavors and substantial bitterness. The flavors are bold but complementary, and are stronger and richer than average-strength pale and amber American ales.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A well-hopped American interpretation of the richest and strongest of the English ales. The hop character should be evident throughout, but does not have to be unbalanced. The alcohol strength and hop bitterness often combine to leave a very long finish.",
      ...
      },
      {
        ...
        "letter": "D",
        "guidelines": {
          "overallImpression": "A richly textured, high alcohol sipping beer with a significant grainy, bready flavor and sleek body. The emphasis is first on the bready, wheaty flavors with interesting complexity from malt, hops, fruity yeast character and alcohol complexity.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A very pale, refreshing, low-alcohol German wheat beer with a clean lactic sourness and a very high carbonation level. A light bread dough malt flavor supports the sourness, which shouldn’t seem artificial. Any Brettanomyces funk is restrained.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A sour, fruity, red wine-like Belgian-style ale with interesting supportive malt flavors and fruit complexity. The dry finish and tannin completes the mental image of a fine red wine.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A malty, fruity, aged, somewhat sour Belgian-style brown ale.",
      ...
      },
      {
        ...
        "letter": "D",
        "guidelines": {
          "overallImpression": "A fairly sour, often moderately funky wild Belgian wheat beer with sourness taking the place of hop bitterness in the balance. Traditionally spontaneously fermented in the Brussels area and served uncarbonated, the refreshing acidity makes for a very pleasant café drink.",
      ...
      },
      {
        ...
        "guidelines": {
          ...
          "instruction": "The type of fruit used must be specified. The brewer must declare a carbonation level (low, medium, high) and a sweetness level (low/none, medium, high). ",
          "vitalStatistics": {
            "og": "1.040 - 1.060",
            "fg": "1.000 - 1.010",
            "abv": "5.0 - 7.0%",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A refreshing, elegant, tasty, moderate-strength wheat-based ale.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A fairly strong, malt-accentuated, lagered artisanal beer with a range of malt flavors appropriate for the color. All are malty yet dry, with clean flavors and a smooth character.",
          ...
          "instruction": "Entrant must specify blond, amber, or brown bière de garde. If no color is specified, the judge should attempt to judge based on initial observation, expecting a malt flavor and balance that matches the color.",
          "vitalStatistics": {
            "og": "1.060 - 1.080",
            "fg": "1.008 - 1.016",
            "abv": "6.0 - 8.5%",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A moderate-strength golden ale that has a subtle fruity-spicy Belgian yeast complexity, slightly malty-sweet flavor, and dry finish.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "Most commonly, a pale, refreshing, highly-attenuated, moderately-bitter, moderate-strength Belgian ale with a very dry finish. Typically highly carbonated, and using non-barley cereal grains and optional spices for complexity, as complements the expressive yeast character that is fruity, spicy, and not overly phenolic. Less common variations include both lower-alcohol and higher-alcohol products, as well as darker versions with additional malt character.",
          ...
          "instruction": "The entrant must specify the strength (table, standard, super) and the color (pale, dark).",
          "vitalStatistics": {
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A pale, complex, effervescent, strong Belgian-style ale that is highly attenuated and features fruity and hoppy notes in preference to phenolics.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A pale, bitter, highly attenuated and well carbonated Trappist ale, showing a fruity-spicy Trappist yeast character, a spicy-floral hop profile, and a soft, supportive grainy-sweet malt palate.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A deep reddish-copper, moderately strong, malty, complex Trappist ale with rich malty flavors, dark or dried fruit esters, and light alcohol blended together in a malty presentation that still finishes fairly dry.",
      ...
      },
      {
        ...
        "letter": "D",
        "guidelines": {
          "overallImpression": "A dark, complex, very strong Belgian ale with a delicious blend of malt richness, dark fruit flavors, and spicy elements. Complex, rich, smooth and dangerous.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "A highly-carbonated, tart and fruity wheat ale with a restrained coriander and salt character and low bitterness. Very refreshing, with bright flavors and high attenuation.",
      ...
      },
      {
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "A darker-colored, light-flavored, malt-accented beer with a dry finish and interesting character malt flavors. Refreshing due to its high carbonation and mild flavors, and highly sessionable due to being served very fresh and with restrained alcohol levels.",
      ...
      },
      {
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "A sour, smoked, lower-gravity historical German wheat beer. Complex yet refreshing character due to high attenuation and carbonation, along with low bitterness and moderate sourness. ",
      ...
      },
      {
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "A luscious, sweet, malt-oriented dark brown ale, with caramel and toffee malt complexity and a sweet finish.",
      ...
      },
      {
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "A low-gravity, highly-carbonated, light-bodied ale combining an oak-smoked flavor with a clean hop bitterness. Highly sessionable.",
      ...
      },
      {
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "An American adaptation of English Porter using American ingredients, including adjuncts.",
      ...
      },
      {
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "A dunkelweizen made with rye rather than wheat, but with a greater body and light finishing hops.",
      ...
      },
      {
        ...
        "letter": "",
        "guidelines": {
          "overallImpression": "A sweet, heavy, strong traditional Finnish beer with a rye, juniper, and juniper berry flavor and a strong banana-clove yeast character.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "guidelines": {
          ...
          "instruction": "The entrant must specify either a base beer style (Classic Style, or a generic style family) or provide a description of the ingredients/specs/desired character. The entrant must specify if a 100% Brett fermentation was conducted. The entrant may specify the strain(s) of Brettanomyces used.",
          "vitalStatistics": {
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A sour and/or funky version of a base style of beer.",
          ...
          "instruction": "The entrant must specify a description of the beer, identifying the yeast/bacteria used and either a base style or the ingredients/specs/target character of the beer.",
          "vitalStatistics": {
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A sour and/or funky version of a fruit, herb, or spice beer, or a wild beer aged in wood. If wood-aged, the wood should not be the primary or dominant character.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A harmonious marriage of fruit and beer, but still recognizable as a beer. The fruit character should be evident but in balance with the beer, not so forward as to suggest an artificial product.",
          ...
          "ingredients": "",
          "comparison": "",
          "instruction": "The entrant must specify a base style, but the declared style does not have to be a Classic Style. The entrant must specify the type(s) of fruit used. Soured fruit beers that aren’t lambics should be entered in the American Wild Ale category.",
          ...
          "vitalStatistics": {
            ...
            "srm": "Vary depending on the underlying base beer, but the fruit will often be reflected in the color."
          }
        },
        "commercialExamples": [{
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A harmonious marriage of fruit, spice, and beer, but still recognizable as a beer. The fruit and spice character should each be evident but in balance with the beer, not so forward as to suggest an artificial product.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A harmonious marriage of fruit, sugar, and beer, but still recognizable as a beer. The fruit and sugar character should both be evident but in balance with the beer, not so forward as to suggest an artificial product.",
          ...
          "ingredients": "",
          "comparison": "",
          "instruction": "The entrant must specify a base style; the declared style does not have to be a Classic Style. The entrant must specify the type of fruit used. The entrant must specify the type of additional fermentable sugar or special process employed.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A harmonious marriage of SHV and beer, but still recognizable as a beer. The SHV character should be evident but in balance with the beer, not so forward as to suggest an artificial product.",
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "An amber to copper, spiced beer that often has a moderately rich body and slightly warming finish suggesting a good accompaniment for the cool fall season, and often evocative of Thanksgiving traditions.",
          ...
          "vitalStatistics": {
            "og": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "fg": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "abv": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer. ABV is generally above 5%, and most examples are somewhat amber-copper in color.",
            "ibu": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "srm": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer."
          }
        },
        "commercialExamples": [{
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "overallImpression": "A stronger, darker, spiced beer that often has a rich body and warming finish suggesting a good accompaniment for the cold winter season.",
          ...
          "vitalStatistics": {
            "og": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "fg": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "abv": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer. ABV is generally above 6%, and most examples are somewhat dark in color.",
            "ibu": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "srm": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer."
          }
        },
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A base beer enhanced by or featuring the character of additional grain or grains. The specific character depends greatly on the character of the added grains.",
          ...
          "ingredients": "",
          "comparison": "",
          "instuctions": "The entrant must specify a base style, but the declared style does not have to be a Classic Style. The entrant must specify the type of alternative grain used.",

          "vitalStatistics": {
            "og": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "fg": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "abv": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "ibu": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer.",
            "srm": "OG, FG, IBUs, SRM and ABV will vary depending on the underlying base beer."
          }
        },
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A harmonious marriage of sugar and beer, but still recognizable as a beer. The sugar character should both be evident but in balance with the beer, not so forward as to suggest an artificial product.",
          ...
          "ingredients": "",
          "comparison": "",
          "instructions": "The entrant must specify a base style, but the declared style does not have to be a Classic Style. The entrant must specify the type of sugar used.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A smoke-enhanced beer showing good balance between the smoke and beer character, while remaining pleasant to drink. Balance in the use of smoke, hops and malt character is exhibited by the better examples.",
          ...
          "comparison": "",
          "instructions": "The entrant must specify a Classic Style base beer. The entrant must specify the type of wood or smoke if a varietal smoke character is noticeable.",
          "vitalStatistics": {
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "overallImpression": "A smoke-enhanced beer showing good balance between the smoke, the beer character, and the added ingredients, while remaining pleasant to drink. Balance in the use of smoke, hops and malt character is exhibited by the better examples.",
          ...
          "comparison": "",
          "instructions": "The entrant must specify a base beer style; the base beer does not have to be a Classic Style. The entrant must specify the type of wood or smoke if a varietal smoke character is noticeable. The entrant must specify the additional ingredients or processes that make this a specialty smoked beer.",
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "letter": "A",
        "guidelines": {
          "overallImpression": "A harmonious blend of the base beer style with characteristics from aging in contact with wood. The best examples will be smooth, flavorful, well-balanced and well-aged. ",
      ...
      },
      {
        ...
        "guidelines": {
          ...
          "overallImpression": "A harmonious blend of the base beer style with characteristics from aging in contact with wood (including alcoholic products previously in contact with the wood). The best examples will be smooth, flavorful, well-balanced and well-aged. ",
        ...
        "commercialExamples": [{
          ...
          {
            "name": "J.W. Lees Harvest Ale in Port, Sherry, Lagavulin Whisky or Calvados Casks"
          },
          {
            "name": "The Lost Abbey Angel’s Share Ale; many microbreweries have specialty beers served only on premises often directly from the cask."
          }
        ],
        "tags": [{
            "tag": "specialty-beer"
  ...
  },
  {
    ...
    "subcategories": [{
        ...
        "guidelines": {
          ...
          "vitalStatistics": {
            "og": "OG, FG, IBUs, SRM and ABV will vary depending on the declared beer.",
            "fg": "OG, FG, IBUs, SRM and ABV will vary depending on the declared beer.",
            "abv": "OG, FG, IBUs, SRM and ABV will vary depending on the declared beer.",
            "ibu": "OG, FG, IBUs, SRM and ABV will vary depending on the declared beer.",
            "srm": "OG, FG, IBUs, SRM and ABV will vary depending on the declared beer."
          }
        },
        "commercialExamples": [{
          "name": ""
      ...
      },
      {
        ...
        "letter": "B",
        "guidelines": {
          "desc": "This style is intended for combinations of existing styles (Classic Beers or Specialty-Type) that are not defined elsewhere in the guidelines. If a ‘mixed-style beer’ does fit another style, do not enter it here.",
          "overallImpression": "Based on the declared base styles. As with all Specialty-Type Beers, the resulting combination of beer styles needs to be harmonious and balanced, and be pleasant to drink.",
          ...
          "ingredients": "",
          "comparison": "",
          "instructions": "The entrant must specify the styles being mixed. The entrant may provide an additional description of the sensory profile of the beer or the vital statistics of the resulting beer.",
      ...
      },
      {
        ...
        "letter": "C",
        "guidelines": {
          "desc": "This is explicitly a catch-all category for any beer that does not fit into an existing style description. No beer is ever “out of style” in this style, unless it fits elsewhere. This is the last resort for any beer entered into a competition.",
